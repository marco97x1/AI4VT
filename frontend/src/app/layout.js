        ...
        <header className="w-full bg-white text-gray-800 py-6 shadow-lg">
          <div className="max-w-6xl mx-auto px-4 flex justify-between items-center">
            <h1 className="text-3xl font-extrabold flex items-center space-x-4">
              <img src="/public/globe.svg" alt="AI4VT Logo" className="h-10 w-10" />
              <span className="tracking-wide">AI4VT</span>
            </h1>
            <nav className="flex space-x-4">
              <a href="https://github.com/marco97x1" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 bg-black text-white px-4 py-2 rounded-md">
                <img src="/public/github-icon.png" alt="GitHub" className="h-6 w-6" />
                <span>GitHub</span>
              </a>
              <a href="https://www.linkedin.com/in/marco-beinat-5350581bb/" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 bg-blue-600 text-white px-4 py-2 rounded-md">
                <img src="/public/linkedin-app-icon.png" alt="LinkedIn" className="h-6 w-6" />
                <span>LinkedIn</span>
              </a>
            </nav>
          </div>
